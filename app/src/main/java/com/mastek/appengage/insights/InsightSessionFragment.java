...
public class InsightSessionFragment extends Fragment implements InsightFragment.InsightDateChangeListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_insight_session, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mChart = (LineChart) view.findViewById(R.id.chartInsightsSessions);
        mChart1=(LineChart)view.findViewById(R.id.chartInsightsSessions1);
...
// set the marker to the chart
    ...
    public void setLineChart(List<InsightSessionResposeModel> lineChart) {
        ...
        for (int i = 0; i < lineChart.size(); i++) {
            ...
            yvalues.add(new Entry(Float.parseFloat(lineChart.get(i).getTse()), i));
        ...
        LineDataSet dataSet = new LineDataSet(yvalues, "Session");
    ...
    public void dateChanged(String sd, String ed) {
        ...
        webServices.getSessionInsights(sd, ed, App.getInstance().getLoginUser().getAkey()).enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {

                Tools.hideProgress();
                if (response.body() != null) {
                    Log.e("resp Session", response.body());
                    JSONArray jsonArray = null;
                    List<InsightSessionResposeModel> sessionResposeModels = new ArrayList<InsightSessionResposeModel>();

                    try {
                        jsonArray = new JSONArray(response.body());
                        Log.e("Size session", jsonArray.length() + "");
                        if (jsonArray.length() > 0) {
                            for (int i = 0; i < jsonArray.length(); i++) {

                                InsightSessionResposeModel insightSessionResposeModel;
                                insightSessionResposeModel = new Gson().fromJson(jsonArray.getString(i), InsightSessionResposeModel.class);
                                sessionResposeModels.add(insightSessionResposeModel);
                            }
                    ...
                    Log.e("Act size Session", sessionResposeModels.size() + "");
                    setLineChart(sessionResposeModels);
                }
            }
