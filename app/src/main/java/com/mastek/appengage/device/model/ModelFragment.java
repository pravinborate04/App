...
public class ModelFragment extends Fragment implements DeviceFragment.DeviceTypeAndDateRangeListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        pieChart = (PieChart) view.findViewById(R.id.piechartModel);
        piechart1=(PieChart)view.findViewById(R.id.piechartModel1);
    ...
    public void setPieChart(List<ModelResponseModel> pieChartModels) {
        ...
        for(int i=0;i<pieChartModels.size();i++){
            ...
            xVals.add(pieChartModels.get(i).getModel());
        }
    ...
    public void deviceTypeChange(String sd, String ed, String type) {
        Log.e("Model","sd "+sd+" ed "+ed+" type "+type);

        webServices= RetrofitManager.getInstance().call();
        Tools.showProgress(getActivity());

        webServices.getDeviceCounters(Constants.SEARCH_BY_MODEL,sd,ed,type, App.getInstance().getLoginUser().getAkey()).enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                if(response.body()!=null) {
                    ...
                    List<ModelResponseModel> modelResponseModelList = new ArrayList<ModelResponseModel>();
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            ModelResponseModel modelResponseModel;
                            modelResponseModel = new Gson().fromJson(jsonArray.getString(i), ModelResponseModel.class);
                            modelResponseModelList.add(modelResponseModel);
                        }
                    ...
                    Log.e("Act size", modelResponseModelList.size() + "");
                    setPieChart(modelResponseModelList);
                }
            }
